...
const EditProfile = () => {
             ...
             formdata.append("bio",bio)
              formdata.append("profession",profession)
               ...
               if(backendImage){
                ...
                const result=await axios.post(`${serverUri}/api/user/editProfile`,formdata,{withCredentials:true})
    ...
    return (
        <div className='w-full min-h-[100vh] bg-black flex items-center flex-col gap-[20px] '>
            ...
            <div className="w-[80px] h-[80px] md:w-[140px] md:h-[140px] border-2 border-black rounded-full cursor-pointer overflow-hidden" onClick={() => imageInput.current.click()}>
            ...
            <button className='px-[10px] w-[60%] max-w-[400px]   py-[5px] h-[50px] bg-blue-500 cursor-pointer rounded-2xl' onClick={handleEditProfile}>{loading?<ClipLoader size={30} color='black'/>:"Save Profile"}</button>
